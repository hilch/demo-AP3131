...
/* Constants */
 ...
 #endif
 _GLOBAL_CONST unsigned long fltMODE_SYNCHRON;
 _GLOBAL_CONST unsigned long fltMODE_ASYNCHRON;
 _GLOBAL_CONST unsigned long fltMODE_PACKET;
 _GLOBAL_CONST unsigned long fltMODE_FRAME;
 _GLOBAL_CONST unsigned long fltMODE_STREAM;
 _GLOBAL_CONST unsigned short fltERR_FRAME_FINISHED;
 _GLOBAL_CONST unsigned short fltERR_CFG_INVALID;
 _GLOBAL_CONST unsigned short fltERR_SEQUIN_INVALID;
 _GLOBAL_CONST unsigned short fltERR_MTU_INVALID;
 _GLOBAL_CONST unsigned short fltERR_FIFO_OVERRUN;
 _GLOBAL_CONST unsigned short fltERR_BUF_SMALL;
 _GLOBAL_CONST unsigned short fltERR_BUF_INVALID;
 _GLOBAL_CONST unsigned short fltERR_BUF_WRONG;
 _GLOBAL_CONST unsigned short fltERR_SYNC;
#endif
...
_BUR_PUBLIC void fltRead(struct fltRead* inst);
_BUR_PUBLIC void fltWrite(struct fltWrite* inst);
